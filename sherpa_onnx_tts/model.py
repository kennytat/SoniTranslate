...
device = "cuda" if 'CUDAExecutionProvider' in providers else ("coreml" if 'CoreMLExecutionProvider' in providers else "cpu")
max_num_sentences = os.getenv("MAX_NUM_SENTENCES",  "1")
